...
# ╔═╡ cba31078-3e25-40f3-be45-105648dab547
begin
	using Random
	using Unicode
...
# ╔═╡ ab4b1cca-f022-11ef-024e-9b65497558f1
md"""
# BetaReader.jl
...
This [Pluto](https://plutojl.org) Notebook provides a tutorial for using [Julia](https://julialang.org) to transliterate Greek.

"""

# ╔═╡ b376d106-c17e-4c5f-a472-078e641ca2c9
md"""
...
# ╔═╡ 967ba7c8-2160-4988-9e40-88b1e601402e
md"""
### Test Configuration

The code below should confirm that everything is working properly. If you see a terminal-cell that says "Μῆνιν ἄειδε Θεά", the configuration works!
"""

# ╔═╡ cf8f772d-ad8c-42cb-813f-193a604978fd
begin
	betacodestring = "Mh=nin a)/eide Qea/"
	unicodestring = BetaReader.betaToUnicode(betacodestring)
	println(""" "$betacodestring"  →  "$unicodestring" """)
end
...
manifest_format = "2.0"
project_hash = "2932fcdf630b5a67fbb92396fd28d23e4ebaddbf"
